...
struct ChatDetailScreen: View {
    ...
    private let templates: [MessageTemplate] = [
        .init(
                   title: "Профиль",
                   text: """
                   Здравствуйте. Напишите, пожалуйста, ID вашего проекта на сайте streamvi.io
        ...
        .init(
                    title: "Разрывы",
                    text: """
                    Здравствуйте. Вот видео для понимания проблем
                ...
                .init(
                    title: "ЭДО",
                    text: """
                    Отправьте приглашение по следующим реквизитам:
